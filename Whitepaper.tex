...
they struggle to maintain their effectiveness is during upgrades. Once an
upgrade occurs, the whole system needs to be reaudited ensure the same
...
format on those transactions. Beaker follows a
exokernel design, where the kernel itself should stay out of the user's
code as much as possible.

We an divide the calls that a Beaker kernel has to accept into two categories:
